...
describe("CircularBuffer", () => {
  ...
  test("initializing capacity of 0 i32s should result in a linear memory with 1 page", () => {
    expect(currentInstance.exports.init(0)).toEqual(0);
    expect(currentInstance.exports.mem.buffer.byteLength / 65536).toEqual(1);
  });

  test("initializing capacity of 16384 i32s should result in a linear memory with 1 page", () => {
    expect(currentInstance.exports.init(16384)).toEqual(0);
    expect(currentInstance.exports.mem.buffer.byteLength / 65536).toEqual(1);
  });

  test("initializing capacity of 16385 i32s should result in a linear memory with 2 pages", () => {
    expect(currentInstance.exports.init(16385)).toEqual(0);
    expect(currentInstance.exports.mem.buffer.byteLength / 65536).toEqual(2);
  });

  test("initializing capacity of 32768 i32s should result in a linear memory with 2 pages", () => {
    expect(currentInstance.exports.init(32768)).toEqual(0);
    expect(currentInstance.exports.mem.buffer.byteLength / 65536).toEqual(2);
  });

  test("initializing capacity of 32769 i32s should result in a linear memory with 3 pages", () => {
    expect(currentInstance.exports.init(32769)).toEqual(0);
    expect(currentInstance.exports.mem.buffer.byteLength / 65536).toEqual(3);
  });

  test("initializing capacity of 49152 i32s should result in a linear memory with 3 pages", () => {
    expect(currentInstance.exports.init(49152)).toEqual(0);
    expect(currentInstance.exports.mem.buffer.byteLength / 65536).toEqual(3);
  });

  test("initializing capacity of 49153 i32s should result in a linear memory with 4 pages", () => {
    expect(currentInstance.exports.init(49153)).toEqual(0);
    expect(currentInstance.exports.mem.buffer.byteLength / 65536).toEqual(4);
  });

  test("initializing capacity of 65536 i32s should result in a linear memory with 4 pages", () => {
    expect(currentInstance.exports.init(65536)).toEqual(0);
    expect(currentInstance.exports.mem.buffer.byteLength / 65536).toEqual(4);
  });

  test("initializing capacity greater than 65536 should error", () => {
  ...
  test("Should be able to write and read up to the full capacity of four 64Kib pages", () => {
    expect(currentInstance.exports.init(65536)).toEqual(0);
