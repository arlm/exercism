...
describe("promises", () => {
  ...
  describe("race", () => {
    ...
    test("resolves with value of the fastest successful promise", () => {
      const FAST = "FAST";
      return expect(race([slowestPromise("SLOWEST"), slowerPromise("SLOWER"), fastPromise(FAST)])).resolves.toEqual(
        FAST
      );
    });
  ...
  describe("any", () => {
    ...
    test("resolves with value of fastest successful promise", () => {
      const FAST = "FAST";
      return expect(any([slowestPromise("SLOWEST"), slowerPromise("SLOWER"), fastPromise(FAST)])).resolves.toEqual(
        FAST
      );
    });
