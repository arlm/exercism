...
describe("FlattenArray", () => {
  ...
  test("5 level nesting", () => {
    expect(flatten([0, 2, [[2, 3], 8, 100, 4, [[[50]]]], -2])).toEqual([0, 2, 2, 3, 8, 100, 4, 50, -2]);
  });
  ...
  test("6 level nest list with null values", () => {
    expect(flatten([0, 2, [[2, 3], 8, [[100]], null, [[null]]], -2])).toEqual([0, 2, 2, 3, 8, 100, -2]);
  });

  test("all values in nested list are null", () => {
    expect(flatten([null, [[[null]]], null, null, [[null, null], null], null])).toEqual([]);
  });
});
