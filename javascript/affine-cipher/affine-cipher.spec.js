...
describe("Affine cipher", () => {
  describe("encode", () => {
    ...
    test("encode all the letters", () => {
      expect(encode("The quick brown fox jumps over the lazy dog.", { a: 17, b: 33 })).toBe(
  ...
  describe("decode", () => {
    ...
    test("decode all the letters", () => {
      expect(decode("swxtj npvyk lruol iejdc blaxk swxmh qzglf", { a: 17, b: 33 })).toBe(
        "thequickbrownfoxjumpsoverthelazydog"
      );
    });

    test("decode with no spaces in input", () => {
      expect(decode("swxtjnpvyklruoliejdcblaxkswxmhqzglf", { a: 17, b: 33 })).toBe(
        "thequickbrownfoxjumpsoverthelazydog"
      );
    });
