...
describe("vertical directions", () => {
  ...
  test("should locate words written bottom right to top left", () => {
    ...
    expect(wordSearch.find(["clojure", "elixir", "ecmascript", "rust", "java", "lua"])).toEqual(expectedResults);
  });
  test("should locate words written bottom left to top right", () => {
    ...
    expect(wordSearch.find(["clojure", "elixir", "ecmascript", "rust", "java", "lua", "lisp"])).toEqual(
      expectedResults
    );
  });
  test("should locate words written top right to bottom left", () => {
    ...
    expect(wordSearch.find(["clojure", "elixir", "ecmascript", "rust", "java", "lua", "lisp", "ruby"])).toEqual(
      expectedResults
    );
  });
});
